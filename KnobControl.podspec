...
Pod::Spec.new do |s|
  ...
  s.author             = { "Muhammad Usman" => "muhammad.usman@nxb.com.pk" }
  # Or just: s.author    = "Muhammad Usman"
  # s.authors            = { "Muhammad Usman" => "muhammad.usman@nxb.com.pk" }
  # s.social_media_url   = "http://twitter.com/Muhammad Usman"
  ...
  s.source       = { :git => "https://github.com/iTatla1/KnobControl.git", :tag => "1.0.0" }
